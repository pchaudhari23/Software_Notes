...
# 3.Create new project - Conversational Language Understanding
# 4.Create intents - Schema definition page
# 5.Add sample utterances for intents - Data labeling page
# 6.Create Entities - Schema definition
# 	- Add a learned entity - Location - London, paris, New York
# 	- Add a list entity - Weekday
# 	- Add a prebuilt entity - Date
# 7.Add sample utterances for entities - Data labeling page
# 8.Create, train and test the model
# 9.Deploy a model 
