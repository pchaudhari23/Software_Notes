...
- Optimize performance: Establish a baseline performance, check for search(503 response) or index(207 response) throttle, optimize index size and schema, check performance of individual queries, scale out your index
