...
1. axe-core, @axe-core/react - Run axe against all changes made in a React app in development mode and reports violations in browser console. [Used in development phase]
2. @axe-core/platwright, axe-html-reporter - Used to integrate axe testing in end to end test scenarios and generate HTML report. [Used in testing phase]
3. eslint-plugin-jsx-a11y: https://www.npmjs.com/package/eslint-plugin-jsx-a11y
4. Lighthouse: Chrome dev tools
