...
Atlas: Fully managed, cloud based, multi-platform (AWS, Azure, GCP), database as a service.

Compass: GUI tool for mongo db.
...
Atlas => Organizations => Projects => Clusters (DB server instance) => Database => Collections
