...
2. .NET: Entity framework (LinQ)
3. Node Js: Sequalise, Mongoose

GUI tools: (Alternatives to CLI)

1. Mongo DB: Mongodb compass
2. MySQL: MySQL workbench
3. PostGRE SQL: DBeaver
4. MSSQL: Microsoft SQL Server Management Studio (SSMS)

---

1. How to take database backup?
2. How to migrate db from one to another?
3. Database import/export: Export and Import data from excel to a database and vice versa. Excel, CSV <=> JSON <=> Database (SQL & NoSQL).
